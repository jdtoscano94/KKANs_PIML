...
#RBA
step_RBA=(cap_RBA-max_RBA0)/(((6/10)*EPOCHS)/50000-1)
...
scatter = ax4.scatter(tc, xc, c=lambdas_grid, cmap='coolwarm', s=0.1,vmax=max_RBA/2)
...
plt.tight_layout()
plt.savefig(args.Name+'_Error_RBA-R.png')
plt.show()
